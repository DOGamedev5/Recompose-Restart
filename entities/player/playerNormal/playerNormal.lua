...
function PlayerNormal.new(x, y, world)
	local instance = setmetatable(PlayerBase.new(x, y, world), {__index=PlayerNormal})

	instance.shape = love.physics.newCircleShape(16)
	instance.fixture = love.physics.newFixture(instance.body, instance.shape)
	print(instance.fixture:getFriction())
...
function PlayerNormal:draw()
	...
	love.graphics.circle("fill", x - windowHandler.cameraPos.x, y - windowHandler.cameraPos.y, 16)
end